...
- **What pages do you want the site to contain?**
    ...
    - About us
    - Search / buy type of car - Style / classifications
#
...
### Specifications
The site needs to be completed in 8 weeks. But the time limit can be extended if need be. The site will be created using HTML and CSS with possible Javascript. It will contain a [Home Page], [About Page], and the [Listings Page]..
